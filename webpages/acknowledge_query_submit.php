...
<center class="w3-card-4 w3-light-gray w3-margin" id="messagebox">
<!--    <img src="../media/box-img2.jpg" width="100%" height="290">-->
    <center><b><h3>Hospital Address :</h3>
    ...
    Phone:(+91) 9121672365<br>

    Fax: (+91) 9121672365<br>

        Email: support@lorem.com</b></center><br><br><br><br>
