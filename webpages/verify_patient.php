...
// to be continued
    ...
    {
        $_SESSION["patient_id"]=$uname;
        $row=$result->fetch_assoc();
        if (strcmp($psw,$row["password"])==0 and strcmp($row[identity],"patient")==0)
        {
//        echo true;
        ...
        {
            echo "<script>if(confirm('NOT REGISTERED..would you like to signup?')){window.location.href='new_patient_signup.php'}else{history.back()}</script>";
        }
