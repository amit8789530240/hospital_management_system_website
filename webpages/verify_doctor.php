...
// to be continued
    ...
    {
        $_SESSION["doctor_id"]=$uname;
        
        $row=$result->fetch_assoc();
        if (strcmp($psw,$row["password"])==0 && strcmp($row["identity"],"doctor")==0)
        {
//        echo true;
        ...
        echo "<script> if(confirm('You are not a registered doctor')){history.back();} else{history.back()}</script>";
    }
